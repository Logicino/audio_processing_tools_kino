...
def dealURMP():
    ...
    testdata_path = '/data/xyth/dealed_dataset'
    ...
    for urmp_folder in urmp_folder_list:
        ...
        for file in file_list:
            ...
            #or file.startswith('F0s'):
                file_instrument = file.split('_')[2]
                os.system("cp " + os.path.join(urmp_folder, file) + " " + os.path.join(testdata_path, file_instrument))
